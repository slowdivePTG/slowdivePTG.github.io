...
\makecvfooter{\today}{Chang Liu~~~·~~~Statement of Purpose: MSU}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

...
\cvpub
{ % Description(s)
{\bf 10} first-author papers (including {\bf 1} co-first authorship) among {\bf 37} total publications (h-index: {\bf 14})
}
...
\cvpubitem{P.~Chen, A.~Gal-Yam, S.~Dong, et al.}
{\Cliu}
...
\cvpubitem{C.~L.~Ransome, D.~J.~Sand, K.~A.~Bostroem, et al.}
{\Cliu}
...
{arXiv: 2605.05380, submitted to ApJ.}

\cvpubitem{R.~Hwangbo, J.~Rho, A.~P.~Ravi, et al.}
{\Cliu}
...
{arXiv:2601.18926, submitted to ApJ.}

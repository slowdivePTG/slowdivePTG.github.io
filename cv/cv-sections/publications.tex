...
\cvpub
{ % Description(s)
{\bf 10} first-author papers (including {\bf 1} co-first authorship) among {\bf 39} total publications (h-index: {\bf 15})
}
...
{\Cliu}
{https://academic.oup.com/mnras/article/550/2/stag1193/8715017}
{GOTO identification and broadband modelling of the counterpart to the SVOM GRB 250818B}
{2026, MNRAS, 550, 2.}

\cvpubitem{T.~E.~M\"{u}ller-Bravo et al.}
{\Cliu}
